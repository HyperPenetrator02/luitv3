      ...
      <main className={`flex-1 max-w-7xl mx-auto px-4 py-8 w-full ${showContent ? 'animate-fadeIn' : 'opacity-0'}`}>
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            {/* Global Impact */}
            <section className={`rounded-xl shadow-md p-6 grid grid-cols-2 gap-4 ${darkMode ? 'bg-gradient-to-br from-slate-800 to-slate-700' : 'bg-gradient-to-br from-white to-blue-50 border border-blue-50'
            ...
            <section className="animate-slideUp stagger-3">
              <h3 className={`text-2xl font-bold mb-4 ${darkMode ? 'text-cyan-300' : 'text-gray-800'}`}>✨ Did You Know?</h3>
              <div className={`p-6 rounded-xl border ${darkMode ? 'bg-slate-700 border-cyan-700' : 'bg-white border-cyan-100 shadow-sm'} italic text-xl`}>
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-col gap-4">
              <button onClick={() => navigate('/report')} className="w-full py-4 bg-sky-600 text-white rounded-xl font-bold text-lg hover:bg-sky-700 transition transform hover:scale-105">📸 Report Garbage</button>
              <button onClick={() => navigate('/cleaner')} className="w-full py-4 bg-emerald-600 text-white rounded-xl font-bold text-lg hover:bg-emerald-700 transition transform hover:scale-105">🧹 Join Cleanup</button>
              <button onClick={() => navigate('/leaderboard')} className="w-full py-4 bg-blue-600 text-white rounded-xl font-bold text-lg hover:bg-blue-700 transition transform hover:scale-105">🏆 Leaderboard</button>
              <button onClick={() => navigate('/analytics')} className="w-full py-4 bg-purple-600 text-white rounded-xl font-bold text-lg hover:bg-purple-700 transition transform hover:scale-105">📊 Analytics</button>
            </div>
          </div>
